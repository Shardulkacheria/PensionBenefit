          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl">
                <div className="text-2xl font-bold text-orange-600">₹{result.userProfile.monthlyIncome?.toLocaleString()}</div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-green-50 rounded-2xl shadow-xl p-8 border border-gray-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                  ...
                  <p className="text-2xl font-bold text-gray-700">₹{result.analysis.currentSchemeComparison.currentMonthlyPension?.toLocaleString()}</p>
                </div>
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                  <h4 className="font-semibold text-gray-900 mb-2">Recommended Monthly Pension</h4>
                  <p className="text-2xl font-bold text-green-600">₹{result.analysis.currentSchemeComparison.recommendedMonthlyPension?.toLocaleString()}</p>
                </div>
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          {result.analysis.insights && (
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-blue-50 p-6 rounded-xl border border-purple-200">
                <p className="text-gray-700 text-lg leading-relaxed">{result.analysis.insights.summary}</p>
              </div>
            </div>
          )}
